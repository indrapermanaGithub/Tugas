...
<html lang="en">
    <style>
        body {
            background-image:url("Newfolder/gambar.jpg");
...
<head>
    ...
    <title>Login | Perpustakaan-My ARS</title>
...
<body>
    <div class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('');?>"><strong>PERPUSTAKAAN-ARS</strong></a>
        </div>
...
<div class="row">
    ...
    <div class="col-md-8 ">
        <h4><font face="arial black" size="15" color="Lightgreen"> Welcome to the ARS university Library Application</font></h4><hr class="line-title"> 
